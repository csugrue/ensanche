...
static void format_uuid_v3or5(uuid_tt *uuid, unsigned char hash[16],
							  int v);
...
/* format_uuid_v1 -- make a UUID from the timestamp, clockseq,
 and node ID */
void format_uuid_v1(uuid_tt* uuid, unsigned16 clock_seq,
                    uuid_time_t timestamp, uuid_node_t node)
{
...
/*oid uuid_create_md5_from_name(uuid_t *uuid, uuid_t nsid, void *name,
                               int namelen)
{
    MD5_CTX c;
...
/* format_uuid_v3or5 -- make a UUID from a (pseudo)random 128-bit
 number */
void format_uuid_v3or5(uuid_tt *uuid, unsigned char hash[16], int v)
{
